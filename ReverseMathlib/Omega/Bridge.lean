...
This module contains no mathematics; it is the import surface for the bridge. Importing
`Equivalence` — which imports both direction routes — reaches all five bridge modules.
