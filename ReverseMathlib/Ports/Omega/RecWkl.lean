...
rm_concept rca0Core where
  statement := "RCA₀ core (Turing-ideal presentation): a second-order part is nonempty, \
    downward closed under Turing reducibility, and closed under recursive join. The \
